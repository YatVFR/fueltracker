(function(){
  'use strict';
  const REV='v15.6-current-tank-compact-1';
  ...
  function fixVersion(){const badge=document.querySelector('.brand small');if(badge)badge.textContent='v15.6 Garage';document.title='Fuel Tracker v15.6';}
