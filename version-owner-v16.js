(function(){
  ...
  function ensureAll(){
    ensure('v1640RuntimeRecovery','FuelTrackerRuntimeRecoveryV16','./runtime-recovery-v16.js');
    ensure('v1640UpdateStatus','FuelTrackerUpdateStatusV16','./update-status-v16.js');
    ensure('v1640GarageMaintenance','FuelTrackerGarageMaintenanceV16','./garage-maintenance-v16.js');
    ensure('v1640MaintenanceTrial','FuelTrackerMaintenanceTrialV16','./maintenance-trial-v16.js');
    ensure('v1640MaintenanceType','FuelTrackerMaintenanceTypeV16','./maintenance-type-v16.js');
    ensure('v1640SmartCapture','FuelTrackerSmartCaptureV16','./refuel-smart-capture-v16.js');
    ensure('v1640DataContext','FuelTrackerDataContextV16','./data-context-v16.js');
    ensure('v1640BackupIntegrity','FuelTrackerBackupIntegrityV16','./backup-integrity-v16.js');
    ensure('v1640MasterDbCurrent','FuelTrackerMasterDbCurrentV16','./masterdb-current-v16.js');
    ensure('v1640ICloudTarget','FuelTrackerICloudBackupTargetV16','./icloud-backup-target-v16.js');
  }
