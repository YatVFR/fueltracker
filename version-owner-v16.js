(function(){
  ...
  function ensureAll(){
    ensure('v1643RuntimeRecovery','FuelTrackerRuntimeRecoveryV16','./runtime-recovery-v16.js');
    ensure('v1643UpdateStatus','FuelTrackerUpdateStatusV16','./update-status-v16.js');
    ensure('v1643GarageMaintenance','FuelTrackerGarageMaintenanceV16','./garage-maintenance-v16.js');
    ensure('v1643MaintenanceTrial','FuelTrackerMaintenanceTrialV16','./maintenance-trial-v16.js');
    ensure('v1643MaintenanceType','FuelTrackerMaintenanceTypeV16','./maintenance-type-v16.js');
    ensure('v1643SmartCapture','FuelTrackerSmartCaptureV16','./refuel-smart-capture-v16.js');
    ensure('v1643StationReliability','FuelTrackerStationReliabilityV16','./station-reliability-v16.js');
    ensure('v1643Onboarding','FuelTrackerOnboardingV16','./onboarding-v16.js');
    ensure('v1643DataContext','FuelTrackerDataContextV16','./data-context-v16.js');
    ensure('v1643BackupIntegrity','FuelTrackerBackupIntegrityV16','./backup-integrity-v16.js');
    ensure('v1643MasterDbCurrent','FuelTrackerMasterDbCurrentV16','./masterdb-current-v16.js');
    ensure('v1643ICloudTarget','FuelTrackerICloudBackupTargetV16','./icloud-backup-target-v16.js');
  }
